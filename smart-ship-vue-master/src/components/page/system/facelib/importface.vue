  ...
  <div class="importlib">
    ...
    <div v-if="type == 'import'">
      <div class="step-download">
        ...
        >
        <ul>
          <li>1.点击下载系统提供的成员信息和照片模板</li>
          <li>2.模板解压，获取成员信息Excel、成员照片文件夹</li>
          <li>3.规范填写Excel成员信息，文件夹中添加已命名注册照</li>
    ...
    handleDownload(type) {
      if (type == "template") {
        facelibApis
          ...
          .then((res) => {
            this.download(res, "face_template");
          })
          .catch((err) => {
            this.$message({
              type: "error",
        ...
        facelibApis
          ...
          .then((res) => {
            ...
            this.$emit("close-importface");
            this.download(res, `face_${this.$props.group_id}`);
            this.$message({
              type: "success",
              message: '下载成功',
            });
