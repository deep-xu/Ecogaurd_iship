<template>
  <div class="facelib">
    ...
    <el-drawer
      :title="formDataInit.act == 'add' ? 'Add' : 'Edit'"
    ...
    >
      <importface
        ...
        @close-importface="
          ...
          showImport = false;
        "
        @update-face-table="getTableData()"
      ></importface>
    </el-drawer>
    <el-drawer
    ...
    >
      <facequality
        ...
        :group_id="search.group_id"
        :deviceid="search.device_id"
        @close-facequality="advanceSetting = false"
      ></facequality>
    </el-drawer>
    <el-dialog
    ...
    >
      <faceGroupSetting
        ...
        :group_id="search.group_id"
        :groupList="groupList"
        @update-face-group="getGroupList"
        @close-face-group="
          getGroupList();
...
import { facelibApis, group } from "@/api/libs.js";
import addFace from "./addFace.vue";
import importface from "./importface.vue";
import faceGroupSetting from "./faceGroupSetting.vue";
import facequality from "./facequality.vue";
import { projConfig } from "@/utils/config.js";
import langmixin from "@/utils/langmixin.js";
export default {
  mixins: [langmixin],
  components: { addFace, facequality, importface, faceGroupSetting },
  data() {
    return {
  ...
  methods: {
    ...
    getGroupList() {
      this.groupList = [];
      group
        .getGroupList({ alg: "face", device_id: this.search.device_id })
        .then((res) => {
    ...
    getTableData() {
      ...
      facelibApis.getTableData(params).then((res) => {
